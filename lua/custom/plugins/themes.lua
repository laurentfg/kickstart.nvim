...
vim.pack.add {'https://gitlab.com/sxwpb/halfspace.nvim'}

vim.pack.add {gh 'rmehri01/onenord.nvim'}

vim.pack.add {gh 'L-Colombo/oldschool.nvim'}
...
vim.pack.add {gh 'rockerBOO/boo-colorscheme-nvim'}

vim.pack.add {gh 'Mofiqul/vscode.nvim'}

vim.pack.add {gh 'wtfox/jellybeans.nvim'}

vim.pack.add {gh 'nvzone/minty'}

vim.pack.add {gh 'zootedb0t/citruszest.nvim'}

vim.pack.add {gh 'rktjmp/lush.nvim'}

vim.pack.add {gh'rockyzhang24/arctic.nvim'}
--require('arctic.nvim').setup{
--  branch = 'v2',
